...
<!-- START SEPARATOR  -->
	...
	<div class="container main-wrapper">
			...
			<ul id="filters" class="clearfix">
                                ...
                                <li><a class="active" href="<?php echo base_url(); ?>superadmin/company">poslodavci</a></li>
			...
			<!-- end filter -->
				...
				<tbody>
                                    ...
                                    <?php foreach($all_company as $all):?>
					<tr>
						...
						<td><?php echo hr_oblik_datuma($all->created_date); ?></td>
                                                ...
                                                <td><a href="<?php echo base_url().'superadmin/block_user/'.$all->company_id.'/'.$all->type;?>">Blokiraj</a></td>
                                                <?php }else{?>
                                                <td><a href="<?php echo base_url().'superadmin/deblock_user/'.$all->company_id.'/'.$all->type;?>">Deblokiraj</a></td>
                                                <?php }?>
						<td><a href="<?php echo base_url().'superadmin/look_user/'.$all->company_id.'/'.$all->type;?>">Pregled</a></td>
						<td><a href="<?php echo base_url().'superadmin/delete_user/'.$all->company_id.'/'.$all->type;?>">Obriši</a></td>
					</tr>
