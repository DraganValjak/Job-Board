...
?>
		<div class="divider-page-1px"></div>	
         ...
         <p><?php  echo $company =  ($details['url']) ? '<a href="'.$details['url'].'" target="_blank">'.$details['name'].' <strong style="color:#FF7E00;"> &Rrightarrow;</strong>  </a>' : "<strong>".$details['name']."</strong>";?></p>
         <p>Iskustvo: <strong><?php echo $details['exspirience'];?></strong></p> 
         <p>Kategorije: <strong><?php echo $details['user_license'];?></strong></p> 
        <p>Opis: <?php echo $details['body'];?></p>
        <p>Adresa: <?php echo $details['user_location'];?>, <?php echo $details['state_name'];?></p>
        <p>Tel: <strong><?php echo $details['user_tel'];?></strong></p>
        <p>Javiti se do: <strong><?php echo hr_oblik_datuma($details['date_expires']);?></strong></p>
        <p><?php echo '<a href=mailto:"'.$details['user_email'].'">'.$details['user_email'].'</a>';?></p>
