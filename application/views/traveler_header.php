...
<!--[if (gt IE 9)|!(IE)]><!--><html xmlns="http://www.w3.org/1999/xhtml" xml:lang="hr" lang="hr" class="no-js"> <!--<![endif]-->
    <head>
        
        <meta content="text/html; charset=utf-8" http-equiv="Content-Type">
        <title>Povezi Me od  <?php echo $traveller['from'];?> do <?php echo $traveller['to'];?></title>
        <meta name="author" content="Dragan Valjak">
	<meta name="keywords" content="Povezi Me od  <?php echo $traveller['from'];?> do <?php echo $traveller['to'];?>">
	<meta name="description" content="Povezi Me od  <?php echo $traveller['from'];?> do <?php echo $traveller['to'];?>">
	...
	<link rel="stylesheet" type="text/css" href="<?php  echo base_url();?>css/mediaelementplayer.min.css" />
	...
	<script type="text/javascript" src="http://code.jquery.com/jquery-1.7.1.min.js"></script>
        ...
        <script type="text/javascript" src="<?php  echo base_url();?>js/jquery.ui.datepicker-hr.js"></script>	
	...
	<script type="text/javascript" src="<?php  echo base_url();?>js/jcarousel.min.js"></script>
