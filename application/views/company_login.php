...
?>
	...
	<div id="separator">
		...
		<div class="container">
			<!-- start separator -->
			<div class="cta-block">
				<h4 class="page-title">Prijava za poslodavce</h4>
			</div><!-- sixteen columns -->
		</div><!-- .container -->
...
<!-- START PAGE WRAPPER -->
	<div class="container main-wrapper">
       ...
       <?php echo form_open('login/login_validation','id="ajax-contact-form-main"');
      ...
      <label for="password">Vaša zaporka</label>
       ...
       <div class="clear"></div>
       <input type="submit" class="submit no-margin-bottom" name="company_submit" value="Prijava"/>
       
       <?php
      echo form_close();
      ?>
        <div class="clear"></div>
        <p style="margin:15px 0px;"><a style="color:#FF7E00;" href="<?php echo base_url(); ?>login/forgot"><small>Zaboravili ste zaporku?</small></a></p>
